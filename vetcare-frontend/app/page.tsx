            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:py-20 sm:px-6 lg:px-8">
                ...
                <div className="mb-16 text-center max-w-3xl mx-auto">
                    ...
                    <h1 className="mb-6 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl">
                        Everything you need for <span className="text-primary-600">Vet Care</span> excellence.
                    </h1>
            ...
            <div className="py-12 border-t border-gray-100 mt-20 bg-gray-50/50">
                <div className="mx-auto max-w-7xl px-4 text-center">
                    <div className="flex justify-center items-center gap-2 mb-4">
                        ...
                        <span className="text-xl font-bold text-gray-900 tracking-tight">Vet Care</span>
                    </div>
                    <p className="text-gray-500 text-sm font-medium">© 2026 Vet Care Technologies. Empowering Veterinary Professionals Worldwide.</p>
                </div>
            </div>
        </div>
    );
